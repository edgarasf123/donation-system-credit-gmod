...
"pw_add_wep", <string:steamid>, <string:class>
	...
	Examples:
		...
		DonationSystem: 	array( 'serverid' => 'darkrp', 'delay' => 0, 'online' => true, 'cmd_name' => 'sv_cmd', 'cmd_args' => array( 'pw_add_wep', '%steamid%', 'weapon_ak47' ) )
...
"pw_add_ammo", <string:steamid>, <string:class>, <number:amount>
	...
	Examples:
		...
		DonationSystem:		array( 'serverid' => 'darkrp', 'delay' => 0, 'online' => true, 'cmd_name' => 'sv_cmd', 'cmd_args' => array( 'pw_add_ammo', '%steamid%', 'ammo_ak47', '100' ) )
...
"pw_remove", <string:steamid>, <string:class>
	...
	Examples:
		...
		DonationSystem:		array( 'serverid' => 'darkrp', 'delay' => 0, 'online' => true, 'cmd_name' => 'sv_cmd', 'cmd_args' => array( 'pw_remove', '%steamid%', 'weapon_ak47' ) )
